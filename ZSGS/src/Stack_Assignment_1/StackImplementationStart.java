...
public class StackImplementationStart {
	...
	private void flowManager() {
		...
		while(isExit) {
			...
			switch(choice) {
				case 1 :
					new StackImplementor().stackPushing();
					break;
				case 2 :
					new StackImplementor().stackPoping();
					break;
				case 3 :
					new StackImplementor().stackPeekElementChecker();
					break;
				case 4 :
					isExit=false;
	...
	public static void main(String[] args) {
		new StackImplementationStart().flowManager();
