...
public class FemaleFatherrelation {
	...
	void fatherRelation(String fathersName) {
		...
		private void sisterChildFinding(String sisterName) {
			...
			while(iterator2.hasNext()) {
				...
				if(FamilyMap.map.get(sisterchild).mothersName.equals(sisterName)  &&  FamilyMap.map.get(sisterchild).gender =='m' ) {
					System.out.println("Fater relationfemale");
