...
public class FemaleMotherrelation {
	...
	private void brotherChildFinding(String brotherName ) {
		...
		while(iterator2.hasNext()) {
			...
			if(FamilyMap.map.get(brotherchild).fathersName.equals(brotherName)  &&  FamilyMap.map.get(brotherchild).gender =='m' ) {
				System.out.println("mother relation female");
